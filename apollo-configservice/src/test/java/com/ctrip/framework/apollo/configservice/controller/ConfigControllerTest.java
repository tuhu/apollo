...
public class ConfigControllerTest {
  ...
  public void testQueryConfig() throws Exception {
    ...
    when(configService.loadConfig(someAppId, someAppTag, someClientIp, someAppId, someClusterName, defaultNamespaceName,
    ...
    ApolloConfig result = configController.queryConfig(someAppId, someClusterName,
        ...
        someClientIp, someAppTag, someMessagesAsString, someRequest, someResponse);

    verify(configService, times(1)).loadConfig(someAppId, someAppTag, someClientIp, someAppId, someClusterName,
  ...
  public void testQueryConfigFileWithPrivateNamespace() throws Exception {
    ...
    when(configService.loadConfig(someAppId, someAppTag, someClientIp, someAppId, someClusterName, somePrivateNamespace,
        someDataCenter, someNotificationMessages)).thenReturn(someRelease);
    when(someRelease.getReleaseKey()).thenReturn(someServerSideNewReleaseKey);
  ...
  public void testQueryConfigWithApolloConfigNotModified() throws Exception {
    ...
    ApolloConfig result =
        configController.queryConfig(someAppId, someClusterName, defaultNamespaceName, someDataCenter, String.valueOf
            (someClientSideReleaseKey), someClientIp, someAppTag, someMessagesAsString, someRequest, someResponse);
  ...
  public void testQueryConfigWithAppOwnNamespace() throws Exception {
    ...
    when(configService.loadConfig(someAppId, someAppTag, someClientIp, someAppId, someClusterName, someAppOwnNamespaceName,
        someDataCenter, someNotificationMessages)).thenReturn(someRelease);
  ...
  public void testQueryConfigWithPubicNamespaceAndNoAppOverride() throws Exception {
    ...
    when(configService.loadConfig(someAppId, someAppTag, someClientIp, someAppId, someClusterName, somePublicNamespaceName,
        someDataCenter, someNotificationMessages)).thenReturn(null);
    when(appNamespaceService.findPublicNamespaceByName(somePublicNamespaceName))
        .thenReturn(somePublicAppNamespace);
    when(configService.loadConfig(someAppId, someAppTag, someClientIp, somePublicAppId, someClusterName, somePublicNamespaceName,
  ...
  public void testQueryConfigWithPublicNamespaceAndAppOverride() throws Exception {
    ...
    ApolloConfig result =
        configController
            .queryConfig(someAppId, someClusterName, somePublicNamespaceName, someDataCenter,
                someAppSideReleaseKey, someClientIp, someAppTag, someMessagesAsString, someRequest, someResponse);
  ...
  public void testQueryConfigForNoAppIdPlaceHolder() throws Exception {
    ...
    verify(configService, never()).loadConfig(appId, someAppTag, someClientIp, someAppId, someClusterName, defaultNamespaceName,
  ...
  public void testQueryConfigForNoAppIdPlaceHolderWithPublicNamespace() throws Exception {
    ...
    when(appNamespaceService.findPublicNamespaceByName(somePublicNamespaceName))
        .thenReturn(somePublicAppNamespace);
    when(configService.loadConfig(appId, someAppTag, someClientIp, somePublicAppId, someClusterName, somePublicNamespaceName,
        someDataCenter, someNotificationMessages)).thenReturn(somePublicRelease);
    when(somePublicRelease.getReleaseKey()).thenReturn(someServerSideReleaseKey);
    ...
    verify(configService, never()).loadConfig(appId, someAppTag, someClientIp, appId, someClusterName,
