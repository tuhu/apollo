...
public abstract class AbstractConfigService implements ConfigService {
  ...
  public Release loadConfig(String clientAppId, String appTag, String clientIp, String configAppId, String configClusterName,
    ...
    if (!Objects.equals(ConfigConsts.CLUSTER_NAME_DEFAULT, configClusterName)) {
      Release clusterRelease = findRelease(clientAppId, appTag, clientIp, configAppId, configClusterName, configNamespace,
          clientMessages);
    ...
    if (!Strings.isNullOrEmpty(dataCenter) && !Objects.equals(dataCenter, configClusterName)) {
      Release dataCenterRelease = findRelease(clientAppId, appTag, clientIp, configAppId, dataCenter, configNamespace,
          clientMessages);
    ...
    return findRelease(clientAppId, appTag, clientIp, configAppId, ConfigConsts.CLUSTER_NAME_DEFAULT, configNamespace,
        clientMessages);
  }
   ...
   * @return the release
   */
  private Release findRelease(String clientAppId, String appTag, String clientIp, String configAppId, String configClusterName,
